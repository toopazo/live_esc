...
class ParseMsg:
    ...
    def uint16_to_bytearray(uint16):
        ...
        # print("[uint16_to_bytearray] b1 = %s" % b1)
        # print("[uint16_to_bytearray] b2 = %s" % b2)
    ...
    def hexstr_to_uint16(hexstr):
        ...
        # print("[hexstr_to_uint16] hexstr = %s" % hexstr)
        # print("[hexstr_to_uint16] uint16 = %s" % uint16)
    ...
    def bytearray_to_hexstr(data_arr):
        ...
        for byte in data_arr:
            # cnt = cnt + 1
            # print("byte %d = %s = %d = %02X" % (cnt, byte, byte, byte))

            hexstr_i = "%02X" % byte
            hexstr = hexstr + hexstr_i

        # print("[bytearray_to_hexstr] hexstr = %s" % hexstr)
    ...
    def parse_arbitrid(arbitrid):
        ...
        # print("[parse_arbitrid] priority = %s" % priority)
        # print("[parse_arbitrid] sourceid = %s" % sourceid)
        # print("[parse_arbitrid] targetid = %s" % targetid)
        # print("[parse_arbitrid] objctadd = %s" % objctadd)
